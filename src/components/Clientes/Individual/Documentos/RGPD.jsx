...
export default class RGPD extends Component {
    render() {
        return (
            <div className="row">
            <div className="col-md-12">
              <div className="white-box">
                <p>Esta Declaração, elaborada pela entidade XXX (doravante designada por entidade) é uma declaração do tratamento de dados pessoais de trabalhadores.
...
Dados de identificação: XXXXX ;
Situação familiar: XXXXX ;
Dados relativos à actividade profissional: XXXXX ;
Dados relativos a retribuições: XXXXX ;
Outros dados: XXXXX .
...
Para efeitos de retribuições, prestações e regalias de trabalhadores, os dados podem ser conservados por um período máximo de dez anos após a cessação da relação de trabalho;
...
As instituições financeiras que gerem as contas da entidade destinadas ao pagamento da retribuição dos trabalhadores;
As entidades gestoras de Fundos de Pensões ou do Regime de Previdência;
As companhias de seguros com quem é celebrado o contrato de seguro de acidentes de trabalho ou de acidentes pessoais.
...
Obs.:
Os campos de dados podem ser acrescentados caso hajam outras finalidades que correspondem ao conteúdo do mesmo título.
A entidade pode preencher, nos campos das categorias de dados pessoais, elementos necessários de acordo com a sua situação concreta.
A entidade pode preencher um prazo de conservação adequado à própria situação concreta, sendo o prazo proposto por este Gabinete de cinco a dez anos.</p>
              </div>
            </div>
          </div>
        )
